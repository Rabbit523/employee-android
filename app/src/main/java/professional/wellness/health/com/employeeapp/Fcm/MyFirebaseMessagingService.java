...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void handleDataMessage(JSONObject json) {
        ...
        try {
            ...
            JSONObject notification_data = json.getJSONObject("notification_data");
            String title = notification.getString("title");
            String message = notification.getString("body");
            String timestamp = "";


            String type = notification_data.getString("type");
            String clinic_id = "";

            if (type.equals("clockout")) {
                clinic_id = notification_data.getString("clinic_id");
            ...
            //   String clinic_id = notification.getString("clinic_id");
            ...
            if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                ...
                resultIntent.putExtra("clinic_id", clinic_id);
                if (type.equals("announcement")) {
                    showNotificationMessage(this, title, message, timestamp, resultIntent, type);
                } else if (type.equals("clinic_update")) {
                    showNotificationMessage(this, title, message, timestamp, resultIntent, type);
                } else
                    showNotificationMessage(this, title, message, timestamp, resultIntent, type);
