...
public class ViewListMonthDetailAdapter extends RecyclerView.Adapter<ViewListMonthDetailAdapter.ItemViewHolder>{
    ...
    /*    items*/
    public ViewListMonthDetailAdapter(Context context, ArrayList<ViewList> othername_list, String iduser) {
    ...
    @Override
    public ViewListMonthDetailAdapter.ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemLayoutView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_view_list_month, parent, false);

        return new ViewListMonthDetailAdapter.ItemViewHolder(itemLayoutView);
    }

    @Override
    public void onBindViewHolder(final ViewListMonthDetailAdapter.ItemViewHolder holder, final int position) {
