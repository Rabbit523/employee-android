                    ...
                    if (location == null) {
                        ...
                        if (locationManager != null) {
                            ...
                            if (location != null) {
                             ...
                             /*   if(SessionManager.getStopService(GPSTracker.this).equals("start")){

                                    try {
                                        JSONObject object = new JSONObject();
                                        object.put("device_id", SessionManager.getDeviceId(GPSTracker.this));
                                        object.put("platform_type", "android app");
                                        object.put("user_id", SessionManager.getuserId(GPSTracker.this));
                                        object.put("clinic_id", SessionManager.getClinicid(GPSTracker.this));
    ...
    private class locationUpdateAsync extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            ...
            if (progressDialog == null) {
                progressDialog = AppUtills.createProgressDialog(GPSTracker.this);
                progressDialog.show();
            } else {
                progressDialog.show();
            }
